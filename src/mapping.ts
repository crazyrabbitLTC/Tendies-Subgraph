...
export function handleApproval(event: Approval): void {
  ...
  //
  // - contract.GRILL_RATE(...)
  // - contract.GRILL_REWARD(...)
  // - contract.MAX_TOP_HOLDERS(...)
  // - contract.POOL_REWARD(...)
  // - contract.allowance(...)
  // - contract.approve(...)
  // - contract.balanceOf(...)
  // - contract.claimedRewards(...)
  // - contract.decimals(...)
  // - contract.decreaseAllowance(...)
  // - contract.getGrillAmount(...)
  // - contract.getInfoFor(...)
  // - contract.increaseAllowance(...)
  // - contract.lastGrillTime(...)
  // - contract.lastRewardTime(...)
  // - contract.name(...)
  // - contract.owner(...)
  // - contract.paused(...)
  // - contract.pauser(...)
  ...
  // - contract.symbol(...)
  // - contract.topHolder(...)
  // - contract.totalGrilled(...)
  // - contract.totalSupply(...)
  // - contract.transfer(...)
  // - contract.transferFrom(...)
  // - contract.unclaimedRewards(...)
